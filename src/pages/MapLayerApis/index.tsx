...
export default function MapLayerApisPage(): JSX.Element {
  ...
  const updateMutation = useApiMutation(
    (payload: { id: number; data: CreateMapLayerApiBody }) =>
      mapLayerApiService.update(payload.id, payload.data),
    {
      onSuccess: () => {
        dbQuery.refetch()
        setFormDialogOpen(false)
  ...
  function handleFormSubmit(data: CreateMapLayerApiBody) {
    if (selectedApiId) {
      updateMutation.mutate({ id: selectedApiId, data })
      return
    }
